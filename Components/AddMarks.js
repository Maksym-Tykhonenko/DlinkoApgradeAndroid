            ...
            <View style={styles.grid}>
              {MARKS.map(m => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.box,
                    selectedMark === m && {backgroundColor: COLORS[3]},
                  ]}
                  onPress={() => setSelectedMark(m)}>
                  <Text
                    style={[
                      styles.boxText,
                      selectedMark === m && {color: '#fff'},
                    ]}>
                    {m}
                  </Text>
                </TouchableOpacity>
          ...
          <>
            ...
            <View style={styles.tagRow}>
              {filtered.map(s => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    <Text style={[styles.tagText, sel && {color: '#fff'}]}>
                      {s}
                    </Text>
                  </TouchableOpacity>
                );
              ...
              {subject.trim() && !subjectsList.includes(subject.trim()) && (
                <TouchableOpacity
                  style={[styles.tag, {borderStyle: 'dashed'}]}
                  onPress={addSubject}>
            ...
            <View style={styles.footer}>
              <TouchableOpacity
                ...
                <Text style={styles.buttonText}>
                  {step < 3 ? 'Next step' : 'Finish review'}
                </Text>
              </TouchableOpacity>
            </View>
          )}
